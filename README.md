...
* **Syntax Highlighting & Validation**: Real-time syntax checking to help catch errors early, alongside semantic highlighting that is fully customizable via VS Code theme settings.
